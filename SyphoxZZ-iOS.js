...
<style>
  * { box-sizing:border-box; margin:0; padding:0; }
  body { background:#07070d; color:#ddd8ff; font-family:-apple-system,ui-monospace,monospace; font-size:13px; }

  /* HERO */
  .hero {
    background: linear-gradient(160deg, #110a2e 0%, #07070d 70%);
  ...
  .hero::after {
    ...
    background:radial-gradient(circle, #9d00ff18 0%, transparent 70%);
    border-radius:50%; pointer-events:none;
  }
  .hero-eyebrow {
    font-size:9px; letter-spacing:3px; color:#9d00ff88;
  ...
  .hero-credits {
    font-size:11px; color:#4a2a6a; letter-spacing:2.5px;
  ...
  .hero-name span { color:#c020ff; }
  .hero-file {
    font-size:10px; color:#665577; word-break:break-all;
    padding:7px 10px; background:#0d0920;
    border-radius:7px; border-left:3px solid #9d00ff44;
    margin-bottom:14px; line-height:1.5;
    text-align:left;
  }
  .hero-file strong { color:#c020ffaa; }
  .hero-grid { display:grid; grid-template-columns:1fr 1fr; gap:8px; }
  .hg-card {
    background:#0d0920; border-radius:8px;
    padding:9px 12px; border:1px solid #2a1a4a;
  }
  .hg-label { font-size:9px; color:#553366; letter-spacing:1px; text-transform:uppercase; margin-bottom:3px; }
  .hg-val        { font-size:12px; color:#ccbbdd; }
  .hg-val.cyan   { color:#c020ff; font-weight:bold; font-size:14px; }
  .hg-val.warn   { color:#ff8800; font-weight:bold; font-size:13px; }
  .hg-card-warn  { background:#1a0010 !important; border-color:#ff880055 !important; }
  ...
  .lang-btn {
    background:#0d0920; border:1px solid #2a1a4a; border-radius:20px;
    color:#556; font-size:10px; letter-spacing:1px; padding:4px 10px;
    cursor:pointer; font-family:inherit; transition:all 0.2s;
    text-transform:uppercase; font-weight:600;
  }
  .lang-btn:hover { border-color:#9d00ff66; color:#c020ffaa; }
  .lang-btn.active { background:#1a0030; border-color:#c020ff; color:#c020ff; }
  ...
  .appstore-banner {
    ...
    background:linear-gradient(135deg,#150018,#1a0022);
    border:1px solid #6a00aa; border-radius:12px;
    padding:14px 16px; margin-bottom:18px;
  }
  .appstore-left { font-size:32px; flex-shrink:0; }
  .appstore-label { font-size:9px; color:#aa00ff; letter-spacing:2px; text-transform:uppercase; font-weight:bold; }
  .appstore-time  { font-size:18px; font-weight:bold; color:#dd88ff; margin:3px 0; }
  .appstore-hint  { font-size:10px; color:#770099; }

  /* SUMMARY */
  .summary { display:flex; gap:8px; margin-bottom:20px; }
  .stat {
    flex:1; background:#0d0920; border-radius:10px;
    padding:12px 6px; text-align:center; border:1px solid #2a1a4a;
  }
  .stat .num { font-size:28px; font-weight:bold; line-height:1; }
  .stat .lbl { font-size:9px; color:#553366; margin-top:4px; letter-spacing:1px; text-transform:uppercase; }
  ...
  .divider { height:1px; background:#2a1a4a; margin:20px 0; }

  /* CARDS */
  .card {
    background:#0d0920; border-radius:12px;
    margin-bottom:12px; overflow:hidden;
    border:1px solid #2a1a4a; border-left:4px solid #333;
  }
  ...
  .row {
    ...
    border-top:1px solid #2a1a4a; align-items:flex-start;
  }
  .label { color:#553366; min-width:65px; font-size:10px; padding-top:1px; flex-shrink:0; line-height:1.4; }
  .sub   { color:#332244; font-size:9px; }
  .val   { color:#ccbbdd; word-break:break-all; flex:1; font-size:11px; line-height:1.5; }
  .isp    { color:#ffbb00; }
  .reason { color:#ff8a80; }
  ...
  .http-banner { color:#dd44ff; font-weight:bold; text-transform:uppercase; font-size:10px; }
  .none   { color:#332244; }
  .bundle {
    display:inline-block; background:#0d0928; border-radius:5px;
    padding:2px 6px; font-size:9px; color:#664488; margin:1px;
    word-break:break-all; border:1px solid #2a1a4a;
  }
  ...
  .ok {
    background:#0a0a1e; border:1px solid #2a1a4a; color:#a060ff;
...
<div class="hero">
  ...
  <div class="hero-name">Syphox<span>ZZ</span></div>
  <div class="hero-credits">por <span class="credit-name">SyphoxZZ</span></div>
  <div class="lang-bar">
